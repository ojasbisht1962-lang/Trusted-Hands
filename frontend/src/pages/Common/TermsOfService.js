    ...
    <div className="terms-of-service-page">
      <div className="terms-container">
        ...
        <section className="terms-section">
          ...
          <p>
            TrustedHands is a marketplace platform that connects customers with service providers (taskers) 
            for various tasks and services. The Platform facilitates the booking process but does not directly 
            provide the services. We are not responsible for the quality or outcome of services provided by taskers.
          </p>
        </section>
        ...
        <section className="terms-section">
          ...
          <ul>
            ...
            <li>Communicate clearly with taskers</li>
          ...
          <ul>
            ...
            <li>Maintain appropriate licenses, permits, and insurance as required</li>
            <li>Accurately represent your skills and experience</li>
            <li>Complete tasks as described and within agreed timelines</li>
