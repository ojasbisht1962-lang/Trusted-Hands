...
export const authService = {
  ...
  switchRole: async (role) => (await api.post(`/auth/switch-role?role=${role}`)).data,
...
export const bookingService = {
  ...
  getMyBookings: async (status) => (await api.get('/bookings/my-bookings', { params: status ? { status } : {} })).data,
